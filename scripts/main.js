...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function optimizeForDevice(device) {
    ...
    // Device optimizations completed
  }
  ...
  function openWhatsApp(message) {
    ...
    try {
      // Method 1: Direct window.open with noopener
      ...
      console.warn('window.open failed, trying fallback methods');
    }
    ...
    try {
      ...
      console.error('All WhatsApp redirect methods failed:', error);
  ...
  function openTelegram(message) {
    ...
    try {
      ...
      console.error('All Telegram redirect methods failed:', error);
      // Method 3: Create a temporary link and click it
      const link = document.createElement('a');
  ...
  document.getElementById('waMain').addEventListener('click', () => {
    openWhatsApp('Olá! Gostaria de falar com um especialista sobre suas soluções digitais.');
  });

  document.getElementById('tgMain').addEventListener('click', () => {
